...
Because app_realtime_ext depends on appwrite ^12.0.4 which depends on web_socket_channel ^2.4.5, web_socket_channel ^2.4.5 is required.
So, because app_realtime_ext depends on web_socket_channel ^3.0.0, version solving failed.
